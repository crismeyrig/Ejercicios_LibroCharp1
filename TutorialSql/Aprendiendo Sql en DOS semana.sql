...
if object_id ('libros') is not null
 ...
 select titulo+'-'+autor as "Título y autor"
  ...
  --25 Funciones
  --26 Funciones para Manejo  de cadenas
...
if object_id('clientes') is not null
 ...
 -- 42 Combinancion Interna (inner Join)
 -- Primer Problema
   if (object_id('clientes')) is not null
   drop table clientes;
 ...
 --52 Agregar campos y restricciones (alter table)
  if object_id('empleados') is not null
  drop table empleados;
...
--62 Subconsulta (insert)
 ...
 --67 Vistas (información)

 -- 68 Lenguaje de control de flujo (case)
  if object_id('empleados') is not null
  drop table empleados;
...
if object_id('consultas') is not null
 ...
 select documento,nombre,fechanacimiento,
  ...
  from empleados;
  -- 74 Funciones  d etablas de varias instrucciones
  if object_id('empleados') is not null
  drop table empleados;
